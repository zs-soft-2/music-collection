...
import { WISHLIST_ITEM_FEATURE_KEY, WishlistItemStateService } from '@music-collection/api';
...
@NgModule({
	imports: [
		CommonModule,
		StoreModule.forFeature(WISHLIST_ITEM_FEATURE_KEY, fromWishlistItem.reducer),
